       ...
       <div className="card bg-bg-dark relative p-10 pr-6 grid gap-5 mt-10 rounded shadow">
         <div className="flex justify-between items-end">
            ...
            <div className="flex gap-3">
                <HiOutlineMailOpen className='bg-border opacity-60 w-8 h-8 p-2 rounded-full text-white'/>
                <HiOutlinePhoneOutgoing className='bg-border opacity-60 w-8 h-8 p-2 rounded-full text-white'/>
            </div>
         </div>
